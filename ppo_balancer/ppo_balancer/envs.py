...
def make_curriculum_learning_env(velocity_env: UpkieGroundVelocity,
    env_settings: EnvSettings,
    training: bool,
    ...
    accel_env = make_accel_env(velocity_env, env_settings, training=training)
    
    curriculum_learning_env = CurriculumLearning(accel_env, start_apply_force_step, increase_intensity_step)
    
    return curriculum_learning_env