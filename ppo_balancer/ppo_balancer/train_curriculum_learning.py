...
"""
Created on Thu Dec 12 09:52:27 2024
...
import upkie.envs
from envs import make_curriculum_learning_env
...
def parse_command_line_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--start-apply-force-step",
        default=10000,
        type=int,
        help="step from which an sagittal force is apply",
    )
    parser.add_argument(
        "--increase-intensity-step",
        default=10000,
        type=int,
        help="number of step between 2 increments of intensity",
    )
    parser.add_argument(
        "--show",
        default=False,
...
def init_env(
    ...
    start_apply_force_step: int,
    increase_intensity_step: int,
    show: bool,
    spine_path: str,
):
    """!
    ...
    def _init():
        ...
        env = make_curriculum_learning_env(velocity_env, env_settings, training=True, start_apply_force_step=start_apply_force_step, increase_intensity_step=increase_intensity_step)
        return Monitor(env)
        ...
        SubprocVecEnv(
            [
                init_env(
                    ...
                    start_apply_force_step = start_apply_force_step,
                    increase_intensity_step = increase_intensity_step,
                    show=show,
...
if __name__ == "__main__":
    ...
    train_policy(
        ...
        start_apply_force_step = args.start_apply_force_step,
        increase_intensity_step = args.increase_intensity_step,
        show=args.show,
    )
